...
public class VirtualBrewingStand_v1_16_R3 extends TileEntityBrewingStand implements VirtualBrewingStand {

  private EntityPlayer handle;

  public VirtualBrewingStand_v1_16_R3(Player player) {
