...
public class CustomEntityRegistry extends RegistryMaterials {
  ...
  public static CustomEntityRegistry getInstance() {
    ...
    try {
      ...
      Field registryMaterialsField = EntityTypes.class.getDeclaredField("REGISTRY");
  ...
  public void putCustomEntity(int entityId, String entityName, Class<? extends Entity> entityClass) {
    // From CB 1.13 on, entity names are only allowed to be lowercase
  ...
  public EntityTypes get(Object key) {
    return (EntityTypes)wrapped.get(key);
  }
