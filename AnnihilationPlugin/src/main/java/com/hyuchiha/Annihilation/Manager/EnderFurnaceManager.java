  ...
  public static void initFurnaceManager() {
    ...
    switch (Minecraft.Version.getVersion()) {
      ...
      case v1_15_R1:
        ...
        break;
      case v1_16_R1:
        furnaceManager = new FurnaceManager_v1_16_R1(main);
        break;
      case v1_16_R2:
        furnaceManager = new FurnaceManager_v1_16_R2(main);
        break;
      case v1_16_R3:
        furnaceManager = new FurnaceManager_v1_16_R3(main);
        break;
      case v1_17_R1:
        furnaceManager = new FurnaceManager_v1_17_R1(main);
        break;
      case v1_18_R1:
        furnaceManager = new FurnaceManager_v1_18_R1(main);
        break;
      case v1_18_R2:
        furnaceManager = new FurnaceManager_v1_18_R2(main);
        break;
      case v1_19_R1:
        furnaceManager = new FurnaceManager_v1_19_R1(main);
        break;
      case v1_19_R2:
        furnaceManager = new FurnaceManager_v1_19_R2(main);
        break;
      case v1_19_R3:
        furnaceManager = new FurnaceManager_v1_19_R3(main);
        break;
      case v1_20_R1:
      ...
      case v1_20_R3:
        ...
        break;
      case v1_20_R4:
        furnaceManager = new FurnaceManager_v1_20_R4(main);
        break;
      case v1_21_R1:
        furnaceManager = new FurnaceManager_v1_21_R1(main);
        break;
      case v1_21_R2:
        furnaceManager = new FurnaceManager_v1_21_R2(main);
        break;
      case v1_21_R3:
