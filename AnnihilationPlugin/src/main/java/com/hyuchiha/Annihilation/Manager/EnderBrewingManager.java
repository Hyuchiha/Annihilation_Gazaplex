  ...
  public static void initBrewingManager() {
    ...
    switch (Minecraft.Version.getVersion()) {
      ...
      case v1_20_R1:
        ...
        break;
      case v1_20_R2:
        brewingManager = new BrewingManager_v1_20_R2(main);
        break;
      case v1_20_R3:
        brewingManager = new BrewingManager_v1_20_R3(main);
        break;
      case v1_20_R4:
        brewingManager = new BrewingManager_v1_20_R4(main);
        break;
      case v1_21_R1:
        brewingManager = new BrewingManager_v1_21_R1(main);
        break;
      case v1_21_R2:
        brewingManager = new BrewingManager_v1_21_R2(main);
        break;
      case v1_21_R3:
