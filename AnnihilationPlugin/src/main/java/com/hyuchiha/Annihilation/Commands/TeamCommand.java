...
public class TeamCommand implements CommandExecutor {
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
    if (args.length == 0) {
      ...
      sender.sendMessage(Translator.getColoredString("ERRORS.CONSOLE_PLAYER_COMMAND"));
    } else {
      ...
      if (GameManager.getCurrentGame() == null) {
        sender.sendMessage(Translator.getPrefix() + ChatColor.RED + Translator.getColoredString("ERRORS.CANNOT_JOIN_TEAM"));
        return true;
      }
