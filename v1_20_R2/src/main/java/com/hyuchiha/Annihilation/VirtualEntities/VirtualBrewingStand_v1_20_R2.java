...
public class VirtualBrewingStand_v1_20_R2 extends BrewingStandBlockEntity implements VirtualBrewingStand {
    private ServerPlayer handle;

    public VirtualBrewingStand_v1_20_R2(Player player) {
