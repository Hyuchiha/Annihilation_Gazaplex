...
public class VirtualBrewingStand_v1_19_R3 extends BrewingStandBlockEntity implements VirtualBrewingStand {
    private ServerPlayer handle;

    public VirtualBrewingStand_v1_19_R3(Player player) {
