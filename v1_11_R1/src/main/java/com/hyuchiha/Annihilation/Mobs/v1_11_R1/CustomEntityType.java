...
import com.hyuchiha.Annihilation.Mobs.v1_11_R1.NMS.CustomWither;
import com.hyuchiha.Annihilation.Mobs.v1_11_R1.NMS.CustomZombie;
...
public enum CustomEntityType implements EntityType {
  ...
  public void addToMaps(Class clazz, String name, int id) {
    ...
    ((Map) MobUtils.getPrivateField("c", net.minecraft.server.v1_11_R1.EntityTypes.class, null)).put(name, clazz);
    ((Map) MobUtils.getPrivateField("d", net.minecraft.server.v1_11_R1.EntityTypes.class, null)).put(clazz, name);
    //((Map)getPrivateField("e", net.minecraft.server.v1_7_R4.EntityTypes.class, null)).put(Integer.valueOf(id), clazz);
    ((Map) MobUtils.getPrivateField("f", net.minecraft.server.v1_11_R1.EntityTypes.class, null)).put(clazz, id);
