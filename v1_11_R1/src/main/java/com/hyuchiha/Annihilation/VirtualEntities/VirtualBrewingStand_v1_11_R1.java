...
public class VirtualBrewingStand_v1_11_R1 extends TileEntityBrewingStand implements VirtualBrewingStand {

  private EntityPlayer handle;

  public VirtualBrewingStand_v1_11_R1(Player player) {
  ...
  public InventoryHolder getOwner() {
    return () -> new CraftInventoryBrewer(VirtualBrewingStand_v1_11_R1.this);
  }
