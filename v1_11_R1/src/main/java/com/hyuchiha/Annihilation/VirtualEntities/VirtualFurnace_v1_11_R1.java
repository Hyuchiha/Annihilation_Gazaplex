...
public class VirtualFurnace_v1_11_R1 extends TileEntityFurnace implements VirtualFurnace {

    private EntityPlayer handle;

    public VirtualFurnace_v1_11_R1(Player player) {
    ...
    public InventoryHolder getOwner() {
        return () -> new CraftInventoryBrewer(VirtualFurnace_v1_11_R1.this);
    }
