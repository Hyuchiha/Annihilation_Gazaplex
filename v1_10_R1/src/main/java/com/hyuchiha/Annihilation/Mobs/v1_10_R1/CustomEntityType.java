package com.hyuchiha.Annihilation.Mobs.v1_10_R1;

import com.hyuchiha.Annihilation.Mobs.EntityType;
import com.hyuchiha.Annihilation.Mobs.MobUtils;
import com.hyuchiha.Annihilation.Mobs.v1_10_R1.NMS.CustomWither;
import com.hyuchiha.Annihilation.Mobs.v1_10_R1.NMS.CustomZombie;
...
public enum CustomEntityType implements EntityType {
  ...
  public void addToMaps(Class clazz, String name, int id) {
    ...
    ((Map) MobUtils.getPrivateField("f", net.minecraft.server.v1_10_R1.EntityTypes.class, null)).put(clazz, id);
