...
public class VirtualBrewingStand_v1_15_R1 extends TileEntityBrewingStand implements VirtualBrewingStand {

  private EntityPlayer handle;

  public VirtualBrewingStand_v1_15_R1(Player player) {
