...
public class VirtualBrewingStand_v1_21_R4 extends BrewingStandBlockEntity implements VirtualBrewingStand {

    private ServerPlayer handle;

    public VirtualBrewingStand_v1_21_R4(Player player) {
